Module Module1
    Sub Main()
        ...
        Dim Fecha As String
        oAdministracion.Salario = 1925.86
        Importe = oAdministracion.Sueldo(80, "Viajes")
        oAdministracion.Sueldo()
        oAdministracion.Sueldo(5)
        Console.ReadLine()
...
Public Class Empleado
    ...
    Public Overloads Sub Sueldo()
        ...
        Console.ReadLine()
    End Sub
    Public Overloads Function Sueldo(Dia As Integer) As String
        Dim FechaActual As Date
        Dim FechaCobro As String
        FechaActual = Now
        FechaCobro = CStr(Dia) & "/" & CStr(Month(FechaActual)) & "/" & CStr(Year(FechaActual))
        Return FechaCobro
    End Function
    Public Sub VerAlta()
...
Public Class Administrativo : Inherits Empleado
    ...
    Public Overloads Function Sueldo(ImporteIncentivo As Double, TipoIncentivo As String)
        Dim Incentivo As Double
        Select Case TipoIncentivo
            Case "Viajes"
                Incentivo = ImporteIncentivo + 300
            Case "Extra"
                Incentivo = ImporteIncentivo + 100
        End Select
        Return Incentivo
    End Function
